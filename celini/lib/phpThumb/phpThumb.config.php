...
$PHPTHUMB_CONFIG['document_root'] = APP_ROOT . "/user/documents";
...
$PHPTHUMB_CONFIG['cache_directory'] = dirname(__FILE__).'/../../../tmp/pic_cache';
...
function phpThumbURL($ParameterString) {
	$PHPTHUMB_CONFIG = $GLOBALS['PHPTHUMB_CONFIG'];
