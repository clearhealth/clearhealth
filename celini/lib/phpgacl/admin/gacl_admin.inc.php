<?php
// add in a permission check
require_once dirname(__FILE__).'/../../../bootstrap.php';
require_once CELINI_ROOT.'/controllers/Controller.class.php';
$c = new Controller();
if (!$security->acl_qcheck('edit',Me::getInstance(),'resources','admin'))
{
	echo "Error GACL Admin cannot be accessed directly<br>\n";
	exit;
}
...
$gacl_options['compile_dir'] = APP_ROOT.'/tmp/phpgacl_cache';
/*$gacl_options = array(
								'debug' => false,
								'items_per_page' => 100,
...
$smarty_compile_dir = APP_ROOT.'/tmp/phpgacl_smarty';
