...
define('PEAR_CACHE_LITE_ERROR_RETURN', 1);
define('PEAR_CACHE_LITE_ERROR_DIE', 8);

class PEAR_Cache_Lite
{
    ...
    */
    var $_pearErrorMode = PEAR_CACHE_LITE_ERROR_RETURN;
    ...
    */
    ...
    /**
     * API break for error handling in PEAR_CACHE_LITE_ERROR_RETURN mode
     * 
     * In PEAR_CACHE_LITE_ERROR_RETURN mode, error handling was not good because
     * for example save() method always returned a boolean (a PEAR_Error object
     * would be better in PEAR_CACHE_LITE_ERROR_RETURN mode). To correct this without
    ...
    */
    function setToDebug()
    {
        $this->setOption('pearErrorMode', PEAR_CACHE_LITE_ERROR_DIE);
    }
