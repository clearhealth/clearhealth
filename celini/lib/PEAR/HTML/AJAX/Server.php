...
class HTML_AJAX_Server 
{
    ...
    var $javascriptLibraries = array(
        ...
        'jsonRpc'       =>  array('Compat.js','clientPool.js','util.js','main.js','HttpClient.js','Request.js','serializer/JSON.js'),
        'proxyObjects'  =>  array('Compat.js','clientPool.js','util.js','main.js','Request.js','serializer/JSON.js','Dispatcher.js'),
    ...
    function clientJsLocation() 
    {
        if (!$this->clientJsLocation) {
            $path = 'C:\web\php\pear\data'.DIRECTORY_SEPARATOR.'HTML_AJAX'.DIRECTORY_SEPARATOR.'js'.DIRECTORY_SEPARATOR;
