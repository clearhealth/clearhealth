<?php
class PDFDestination extends DestinationProcessor{

	var $_internalName = "PDFDestination";
	var $_label = 'PDF';
	var $_package = null;
	var $_format = null;

	function PDFDestination(){
	}
...
<pdf href="'  . Celini::getBaseURI() . 'index.php/Images/'. $format . '.pdf" xmlns="http://ns.adobe.com/xdp/pdf/" />
	...
	$dpm->registerDestinationProcessor('PDF', 'PDFDestination');
?>
