...
class Event extends ORDataObject{
	...
	function get_events_between($start,$end,$key_type = "day",$foreign_id = "",$code_filter = "",$code_state=true) {
		...
		." u.color as color, u.nickname as nickname, u2.nickname as last_change_nickname, psn.last_name as p_lastname, psn.first_name as p_firstname, DATE_FORMAT(psn.date_of_birth,'%m/%d/%Y') as dob, " 
