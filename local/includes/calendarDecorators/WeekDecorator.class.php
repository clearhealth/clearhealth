...
class WeekDecorator extends Calendar_Decorator {
    
   	/**
   	* @param Calendar_Week
   	*/
   	function WeekDecorator(& $Week) {
   	...
   	*/
   	function prevWeek() {
       	...
       	return $_SERVER['PHP_SELF'].'?main&calendar&action=week&year='.date('Y',$prevStamp).'&month='.date('n',$prevStamp).'&day='.date('j',$prevStamp);
   	}
   	...
   	*/
   	function nextWeek() {
       	...
       	return $_SERVER['PHP_SELF'].'?main&calendar&action=week&year='.date('Y',$nextStamp).'&month='.date('n',$nextStamp).'&day='.date('j',$nextStamp);
