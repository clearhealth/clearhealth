...
class DayBriefDecorator extends Calendar_Decorator {
   	...
   	*/
   	function prevDay() {
       	...
       	return $_SERVER['PHP_SELF'].'?main&calendar&action=day_brief&year='.date('Y',$prevStamp).'&month='.date('n',$prevStamp).'&day='.date('j',$prevStamp);
   	}
   	...
   	*/
   	function nextDay() {
       	...
       	return $_SERVER['PHP_SELF'].'?main&calendar&action=day_brief&year='.date('Y',$nextStamp).'&month='.date('n',$nextStamp).'&day='.date('j',$nextStamp);
