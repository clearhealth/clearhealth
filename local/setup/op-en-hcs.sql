...
-- 
-- Host: localhost
-- Generation Time: Feb 25, 2005 at 11:12 AM
...
CREATE TABLE `addresses` (
  ...
  `type` enum('','main','secondary') NOT NULL default '',
...
INSERT INTO `addresses` VALUES (3, '', '', '', '', '', '', 'USA', 'main', 2);
INSERT INTO `addresses` VALUES (4, '', '', '', '', '', '', 'USA', 'secondary', 2);
INSERT INTO `addresses` VALUES (13, '', '', '', '', '', '', 'USA', 'main', 12);
INSERT INTO `addresses` VALUES (621, '', '', '', '', '', '', 'USA', 'main', 620);
...
CREATE TABLE `phone_numbers` (
  ...
  `type` enum('','home','work','mobile','emergency','fax') default NULL,
  `foreign_id` int(11) default NULL,
  PRIMARY KEY  (`id`),
  KEY `foreign_id` (`foreign_id`)
) TYPE=MyISAM;
...
INSERT INTO `phone_numbers` VALUES (5, '+1', NULL, '', '', 'work', 2);
INSERT INTO `phone_numbers` VALUES (6, '+1', NULL, '', '', 'home', 2);
INSERT INTO `phone_numbers` VALUES (7, '+1', NULL, '', '', 'fax', 2);
...
INSERT INTO `sequences` VALUES (703);
...
INSERT INTO `users` VALUES (1, 'admin', '21232f297a57a5a743894a0e4a801fc3', 'adm', 'AADD11');
