...
PagePrintProgress::PagePrintProgress(void)
{
}
...
NS_IMPL_ISUPPORTS1(PagePrintProgress,
		   nsIWebProgressListener
		   )
/*nsresult
PagePrintProgress::Init(EmbedPrivate *aOwner)
{
  mOwner = aOwner;
  return NS_OK;
}*/
...
NS_IMETHODIMP
PagePrintProgress::OnStateChange(nsIWebProgress *aWebProgress,
			     nsIRequest     *aRequest,
...
NS_IMETHODIMP
PagePrintProgress::OnProgressChange(nsIWebProgress *aWebProgress,
				nsIRequest     *aRequest,
...
NS_IMETHODIMP
PagePrintProgress::OnLocationChange(nsIWebProgress *aWebProgress,
				nsIRequest     *aRequest,
				nsIURI         *aLocation)
{
	/*
...
NS_IMETHODIMP
PagePrintProgress::OnStatusChange(nsIWebProgress  *aWebProgress,
			      nsIRequest      *aRequest,
			      nsresult         aStatus,
...
NS_IMETHODIMP
PagePrintProgress::OnSecurityChange(nsIWebProgress *aWebProgress,
				nsIRequest     *aRequest,
				PRUint32         aState)
{
	/*
...
/* static */
void
PagePrintProgress::RequestToURIString(nsIRequest *aRequest, char **aString)
{
  // is it a channel
