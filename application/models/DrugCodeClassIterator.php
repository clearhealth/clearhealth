...
class DrugCodeClassIterator extends WebVista_Model_ORMIterator implements Iterator {

	public function __construct($dbSelect = null) {
		parent::__construct('DrugCodeClass',$dbSelect);
	}
	...
	public function setFilters($filter) {
		...
		$dbSelect = $db->select()->from('drugCodeClass');
