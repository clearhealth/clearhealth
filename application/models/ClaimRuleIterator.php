...
class ClaimRuleIterator extends WebVista_Model_ORMIterator implements Iterator {

	public function __construct($dbSelect=null) {
		$this->_ormClass = 'ClaimRule';
		if ($dbSelect !== null) {
	...
	public function setFilters($filters) {
		...
		foreach($filters as $key=>$value) {
			switch ($key) {
				case 'groupId':
					$sqlSelect->where('groupId = ?',(int)$value);
					break;
			}
		}
